...
footer .socials img:hover {
  ...
  cursor: pointer;
}`, "",{"version":3,"sources":["webpack://./src/css/index.scss","webpack://./src/css/_variables.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,oBCFW;EDGX,kBAAA;EACA,sBAAA;EACA,2BAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;AADF;;AAIA;EACE,aAAA;EACA,yBCduB;EDevB,UAAA;EACA,YAAA;EACA,mBAAA;EACA,mBAAA;EACA,8BAAA;AADF;AAGE;EACE,WAAA;EACA,iBAAA;EACA,eAAA;AADJ;AAII;EACA,mBAAA;AAFJ;AAIM;EACE,yBAAA;EACA,YAAA;EACA,YAAA;EACA,eAAA;EACA,gBAAA;EACA,kBAAA;AAFR;AAIQ;EACA,kBAAA;AAFR;AAKQ;EACA,iBAAA;AAHR;AAMQ;EACA,iBAAA;EACA,iBAAA;AAJR;AAOQ;EACE,cCrDU;EDsDV,eAAA;AALV;;AAcA;EACE,aAAA;EACA,iEAAA;EACA,0BAAA;EACA,sBAAA;EACA,uBAAA;EACA,aAAA;EACA,YAAA;EACA,mBAAA;EACA,oBAAA;AAXF;AAaE;EC1DE,cAhBgB;EAiBhB,qBAAA;EACA,iBAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,gBAAA;ADgDJ;AC/CI;EACU,yBAAA;EACA,mBA1BM;EA2BN,eAAA;ADiDd;AAEE;EACE,eAAA;EACA,mBAAA;EACA,mBAAA;EACA,gBAAA;EACA,gBAAA;AAAJ;AAGE;ECjFE,iCAAA;EDmFA,YAAA;EACA,aAAA;EACA,mBC1FgB;ED2FhB,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,mBAAA;EACA,eAAA;EACA,kBAAA;AADJ;AAGI;EC7FA,iCAAA;ED+FE,YAAA;EACA,aAAA;AADN;;AAOA;EACE,aAAA;EAGA,mBAAA;EACA,WAAA;EACA,uBAAA;EACA,uBAAA;EACA,eAAA;EACA,yBAAA;AANF;AAQE;EACE,aAAA;EACA,UAAA;EACA,mBAAA;EACA,eAAA;EACA,yBAAA;EACA,uBAAA;EACA,uBAAA;EACA,gBAAA;EACA,aAAA;AANJ;AASE;EACE,WAAA;EACA,eAAA;EACA,kBAAA;AAPJ;AAUE;EAEE,gBADa;EAEb,iBAFa;ECpIb,iCAAA;EDwIA,mBC7IgB;ED8IhB,YClIiB;EDmIjB,aCnIiB;EDoIjB,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,gBAAA;AATJ;AAWI;EChJA,iCAAA;EDkJE,YC1Ic;ED2Id,aC3Ic;ADkIpB;AAcE;EAEE,eAAA;EACA,gBAAA;EACA,oBAAA;EACA,aAAA;EACA,gBAAA;EACA,WAAA;EACA,kBAAA;EACA,iBAAA;EACA,iBATc;EAUd,kBAVc;AAHlB;AAgBE;EACE,kBAAA;AAdJ;AAiBE;EACE,mBAAA;AAfJ;AAkBE;EACE,kBAAA;EACA,kBAAA;AAhBJ;AAmBE;ECxKE,cAhBgB;EAiBhB,qBAAA;EACA,iBAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,gBAAA;ADwJJ;ACvJI;EACU,yBAAA;EACA,mBA1BM;EA2BN,eAAA;ADyJd;;AASA;EACE,aAAA;EACA,yBC/LkB;EDgMlB,WAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,gBAAA;EACA,mBAAA;AANF;AAQE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,YAAA;AANJ;AASE;EACE,iBAAA;AAPJ;AASI;EAEE,iBADa;EAEb,kBAFa;EAIb,YADY;EAEZ,WAFY;AAPlB;AAWM;EACE,0BAAA;EACA,eAAA;AATR","sourcesContent":["@import 'variables';\n\nbody {\n  display: flex;\n  font-family: $font-style;\n  position: absolute;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  padding-top: 14px;\n  padding-left: 13px;\n}\n\nnav {\n  display: flex;\n  background-color: $secondary-accent-color;\n  width: 98%;\n  height: 56px;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n\n  .dogIcon {\n    width: 35px;\n    margin-left: 30px;\n    margin-top: 4px\n    }\n\n    .navButtons {\n    padding-right: 15px;\n  \n      input {\n        background-color: #92E0E5;\n        border: none;\n        color: white;\n        font-size: 20px;\n        font-weight: 500;\n        margin-bottom: 6px;\n\n        &:nth-child(1) {\n        margin-right: -6px;\n        }\n\n        &:nth-child(2) {\n        margin-right: 2px;\n        }\n\n        &:nth-child(3) {\n        margin-right: 9px;\n        margin-left: -6px;\n        }\n\n        &:hover{\n          color: $main-accent-color;\n          cursor: pointer;\n        }\n\n      }\n\n    }\n\n  }\n\n.imageWrapper {\n  display: flex;\n  background: url(../../dist/images/park.jpg) top no-repeat;\n  background-size: 98% 56rem;\n  flex-direction: column;\n  justify-content: center;\n  height: 33rem;\n  width: 100vw;\n  align-items: center;\n  padding-bottom: 21px;\n\n  input {\n    @include buttonFormat;\n  }\n\n  h3 {\n    font-size: 34px;\n    margin-bottom: 21px;\n    padding-bottom: 7px;\n    margin-top: 27px;\n    font-weight: 300\n  }\n\n  .imageBorder {\n    @include circular;\n    width: 330px;\n    height: 330px;\n    background: $main-accent-color;\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    align-items: center;\n    margin-top: 0px;\n    margin-bottom: 1px;\n\n    .dogOne{\n      @include circular;\n      width: 320px;\n      height: 320px;\n    }\n  }\n\n}\n\n.infoPage {\n  display: flex;\n  $infoWidth: 100%;\n  $marginLeft: 100px;\n  flex-direction: row;\n  width: 100%;\n  justify-content: center;\n  align-items: flex-start;\n  flex-wrap: wrap;\n  align-content: flex-start;\n  \n  section{\n    display: flex;\n    width: 30%;\n    flex-direction: row;\n    flex-wrap: wrap;\n    align-content: flex-start;\n    justify-content: center;\n    align-items: flex-start;\n    margin-top: 31px;\n    height: 580px;\n  }\n  \n  h2{\n    width: 100%;\n    font-size: 19px;\n    text-align: center;\n  }\n  \n  .infoImageBorder {\n    $marginLeft: 1px;\n    margin-left: $marginLeft;\n    margin-right: $marginLeft;\n    @include circular;\n    background: $main-accent-color;\n    width: $small-border-width;\n    height: $small-border-width;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-top: 19px;\n\n    img {\n      @include circular;\n      width: $small-image-width;\n      height: $small-image-width;\n    }\n\n  }\n\n  p{\n    $paddingLeft: 4px;\n    font-size: 20px;\n    margin-top: 29px;\n    margin-bottom: -40px;\n    height: 181px;\n    font-weight: 400;\n    width: 100%;\n    text-align: center;\n    line-height: 18px;\n    padding-left: $paddingLeft;\n    padding-right: $paddingLeft;\n  }\n  \n  .factDog{\n    margin-right: 56px;\n  }\n  \n  .whatDog{\n    padding-right: 22px;\n  }\n  \n  .howDog {\n    margin-left: -12px;\n    margin-right: 32px;\n  }\n\n  input {\n    @include buttonFormat;\n  }\n}\n\nfooter {\n  display: flex;\n  background-color: $main-accent-color;\n  width: 98vw;\n  height: 10rem;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding-top: 8px;\n  padding-bottom: 8px;\n\n  h2 {\n    text-align: center;\n    font-size: 20px;\n    font-weight: 400;\n    color: white;\n    }\n\n  .socials {\n    padding-top: 10px;\n    \n    img {\n      $marginLeft: 30px;\n      margin-left: $marginLeft;\n      margin-right: $marginLeft;\n      $imgHeight: 50px;\n      height: $imgHeight;\n      width: $imgHeight;\n\n      &:hover {\n        mix-blend-mode: soft-light;\n        cursor: pointer;\n      }\n\n    }\n\n  }\n\n}","$main-accent-color: #3F8DA8;\n$secondary-accent-color: #92E0E5;\n$font-style: raleway;\n\n@mixin circular {\n    clip-path: circle(50% at 50% 50%);\n}\n\n@mixin hide{\n    display: none;\n}\n\n$small-border-width: 230px;\n$small-image-width: $small-border-width - 5px;\n\n@mixin buttonFormat {\n    color: $main-accent-color;\n    border: solid $main-accent-color;\n    background: white;\n    font-size: 19px;\n    margin-top: 1px;\n    font-weight: 400;\n    padding: 8px 14px;\n    margin-top: 10px;\n    &:hover {\n              color: #14396A !important;\n              background: $main-accent-color;\n              cursor: pointer;\n            }\n}"],"sourceRoot":""}]);
// Exports
